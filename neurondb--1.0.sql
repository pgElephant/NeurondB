...
-- ============================================================================
-- PostgreSQL Version: 16.9 (160900)
...
BEGIN
    ...
    -- Log version info
    RAISE NOTICE 'NeurondB v1.0: Built for PostgreSQL 16.9 on macOS';
    RAISE NOTICE 'NeurondB: Current PostgreSQL version: %.% (expected: 16.9)', 
    ...
    IF v_pg_version_num < (v_expected_version - 100) OR v_pg_version_num >= (v_expected_version + 10000) THEN
        RAISE WARNING 'NeurondB: Built for PostgreSQL 16.9 but running on %.%. Some features may not work correctly.', 
                      v_pg_major, (v_pg_version_num - v_pg_major * 10000) / 100;
    END IF;
