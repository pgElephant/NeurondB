...
typedef struct NdbCudaHfGenParams
{
	...
	int32_t		stop_sequences[NDB_HF_MAX_STOP_SEQUENCES][NDB_HF_MAX_STOP_SEQ_LEN]; /* Stop sequence token IDs */
	int			stop_seq_lens[NDB_HF_MAX_STOP_SEQUENCES]; /* Length of each stop sequence */
