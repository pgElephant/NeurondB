...
SELECT neurondb.train('decision_tree', 'test_train_view', 'features', 'label', '{}'::jsonb)::integer AS gpu_model;

-- CPU Training
SET neurondb.gpu_enabled = off;
SELECT neurondb.train('decision_tree', 'test_train_view', 'features', 'label', '{}'::jsonb)::integer AS cpu_model;
