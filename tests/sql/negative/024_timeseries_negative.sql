...
\echo '=========================================================================='
\echo 'Time Series - Negative Test Cases (Error Handling)'
\echo '=========================================================================='
...
SELECT neurondb.train('timeseries', NULL, 'features', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 2: NULL Feature Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'test_train_view', NULL, 'label', '{}'::jsonb);

\echo ''
\echo 'Test 3: NULL Label Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'test_train_view', 'features', NULL, '{}'::jsonb);

\echo ''
\echo 'Test 4: Invalid Table Name'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'nonexistent_table', 'features', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 5: Invalid Feature Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'test_train_view', 'invalid_feature', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 6: Invalid Label Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'test_train_view', 'features', 'invalid_label', '{}'::jsonb);

\echo ''
\echo 'Test 7: Invalid Hyperparameters'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('timeseries', 'test_train_view', 'features', 'label', '{"window_size":-1}'::jsonb);

\echo ''
\echo 'Test 8: NULL Model ID for Prediction'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.predict(NULL, array_to_vector_float8(ARRAY[1.0]::double precision[]));

\echo ''
\echo 'Test 9: Invalid Model ID for Prediction'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.predict(-1, array_to_vector_float8(ARRAY[1.0]::double precision[]));
