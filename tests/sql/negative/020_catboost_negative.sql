...
\echo '=========================================================================='
\echo 'CatBoost - Negative Test Cases (Error Handling)'
\echo '=========================================================================='
...
SELECT neurondb.train('catboost', NULL, 'features', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 2: NULL Feature Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'test_train_view', NULL, 'label', '{}'::jsonb);

\echo ''
\echo 'Test 3: NULL Label Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'test_train_view', 'features', NULL, '{}'::jsonb);

\echo ''
\echo 'Test 4: Invalid Table Name'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'nonexistent_table', 'features', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 5: Invalid Feature Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'test_train_view', 'invalid_feature', 'label', '{}'::jsonb);

\echo ''
\echo 'Test 6: Invalid Label Column'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'test_train_view', 'features', 'invalid_label', '{}'::jsonb);

\echo ''
\echo 'Test 7: Invalid Hyperparameters'
\echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'

SELECT neurondb.train('catboost', 'test_train_view', 'features', 'label', '{"iterations":-1}'::jsonb);
