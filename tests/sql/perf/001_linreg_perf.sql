 ...
 *
 * 001_linreg_perf.sql
 *    Linear Regression performance test with GPU acceleration
 *    Works on the whole 11M row view
 *
 *-------------------------------------------------------------------------*/
...
/* Step 4: Train model */
\echo 'Step 4: Training linear regression model on full dataset...'
...
\echo 'Step 7: Evaluating model on full test set (optimized C batch processing)...'
...
/* Step 8: Summary */
\echo 'Step 8: Performance test summary...'
