-- 020_catboost_perf.sql
-- Performance test for CatBoost (CPU and GPU)
...
\echo ''
\echo 'Testing CatBoost on CPU (full dataset)...'
...
BEGIN
	BEGIN
		SELECT neurondb.train('catboost', 'perf_train_view', 'features', 'label', '{}'::jsonb) INTO model_id;
...
\echo ''
\echo 'Testing CatBoost on GPU (full dataset)...'
...
\echo 'CatBoost performance test completed successfully'
