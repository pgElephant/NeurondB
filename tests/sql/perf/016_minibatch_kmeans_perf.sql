...
\echo '=========================================================================='
\echo 'Mini-Batch K-Means Clustering - Performance Test (Full Dataset)'
\echo '=========================================================================='

-- Test Mini-Batch K-Means clustering with k=3, batch_size=100 on full dataset
...
\echo 'Mini-Batch K-Means performance test completed successfully'
