...
SELECT neurondb.train('hybrid_search', 'sample_train', 'features', 'label', '{}'::jsonb)::integer AS gpu_model;

-- CPU Training
SET neurondb.gpu_enabled = off;
SELECT neurondb.train('hybrid_search', 'sample_train', 'features', 'label', '{}'::jsonb)::integer AS cpu_model;
