...
ndb_cuda_gmm_estep_kernel(const float *features,
 ...
 */
__global__ static void
ndb_cuda_gmm_mstep_means_kernel(const float *features,
 ...
 */
__global__ static void
ndb_cuda_gmm_mstep_variances_kernel(const float *features,
	const double *responsibilities,
	const double *means,
	const double *N_k,
	int n_samples,
 ...
 */
__global__ static void
ndb_cuda_gmm_compute_Nk_kernel(const double *responsibilities,
	int n_samples,
	int n_components,
	double *N_k)
{
 ...
 */
extern "C" int
ndb_cuda_gmm_estep(const float *features,
	const double *mixing_coeffs,
	const double *means,
	const double *variances,
	int n_samples,
	...
	double *responsibilities)
{
	...
	ndb_cuda_gmm_estep_kernel<<<blocks, threads>>>(d_features, d_mixing, d_means, d_variances, n_samples, feature_dim, n_components, d_resp);
 ...
 */
extern "C" int
ndb_cuda_gmm_mstep(const float *features,
	const double *responsibilities,
	int n_samples,
	int feature_dim,
	int n_components,
	...
	double *variances)
{
	...
	ndb_cuda_gmm_compute_Nk_kernel<<<blocks, threads>>>(d_resp, n_samples, n_components, d_N_k);
	...
	/* Update means */
	ndb_cuda_gmm_mstep_means_kernel<<<n_components, feature_dim>>>(d_features, d_resp, d_N_k, n_samples, feature_dim, n_components, d_means);
	...
	/* Update variances */
	ndb_cuda_gmm_mstep_variances_kernel<<<n_components, feature_dim>>>(d_features, d_resp, d_means, d_N_k, n_samples, feature_dim, n_components, d_variances);
