	...
	int dim)
{
	...
	elog(DEBUG1,
		"neurondb: GPU batch L2 distance not implemented for current "
		"backend; using CPU fallback");
}
	...
	int dim)
{
	...
	elog(DEBUG1,
		"neurondb: GPU batch cosine distance not implemented for "
		"current backend; using CPU fallback");
}
