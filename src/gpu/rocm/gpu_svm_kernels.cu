 ...
 */
__global__ void
ndb_rocm_svm_linear_kernel_kernel(const float *x,
	const float *y,
	int feature_dim,
	float *result)
{
 ...
 */
__global__ void
ndb_rocm_svm_predict_kernel(const float *input,
 ...
 */
__global__ void
ndb_rocm_svm_compute_kernel_row_kernel(const float *features,
	int n_samples,
	int feature_dim,
	int row_idx,
	float *kernel_row)
 ...
 */
__global__ void
ndb_rocm_svm_compute_errors_kernel(const float *alphas,
	const double *labels,
 ...
 */
__global__ void
ndb_rocm_svm_update_errors_kernel(const float *kernel_row,
	float delta_alpha,
	float label_i,
	int n_samples,
	float *errors)
 ...
 */
extern "C" int
ndb_rocm_svm_launch_compute_kernel_row(const float *features,
	int n_samples,
	int feature_dim,
	int row_idx,
	float *kernel_row)
{
	...
	/* Launch kernel */
	hipLaunchKernelGGL(ndb_rocm_svm_compute_kernel_row_kernel,
		dim3(blocks),
 ...
 */
extern "C" int
ndb_rocm_svm_launch_compute_errors(const float *alphas,
	const double *labels,
	const float *kernel_matrix,
	float bias,
	int n_samples,
	float *errors)
{
	...
	/* Launch kernel */
	hipLaunchKernelGGL(ndb_rocm_svm_compute_errors_kernel,
		dim3(blocks),
		dim3(threads_per_block),
		0,
		0,
 ...
 */
extern "C" int
ndb_rocm_svm_launch_update_errors(const float *kernel_row,
	float delta_alpha,
	float label_i,
	int n_samples,
	float *errors)
{
	...
	/* Launch kernel */
	hipLaunchKernelGGL(ndb_rocm_svm_update_errors_kernel,
		dim3(blocks),
		dim3(threads_per_block),
		0,
		0,
