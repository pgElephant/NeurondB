...
SELECT neurondb.train('lasso', 'sample_train', 'features', 'label', '{}'::jsonb)::integer AS gpu_model;

-- CPU Training
SET neurondb.gpu_enabled = off;
SELECT neurondb.train('lasso', 'sample_train', 'features', 'label', '{}'::jsonb)::integer AS cpu_model;
