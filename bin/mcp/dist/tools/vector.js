export class VectorTools {
    ...
    async vectorSearch(params) {
        const { table, vector_column, query_vector, limit = 10, distance_metric = "l2", } = params;
    ...
    async hybridSearch(params) {
        const { table, query_vector, query_text, text_column, vector_column, vector_weight = 0.7, limit = 10, } = params;
        const vectorStr = `[${query_vector.join(",")}]`;
        const query = `
